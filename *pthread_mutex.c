...
pthread_mutex_t mutex = PTHREAD_MUTEX_INITIAL_IZER;
...
int main(){
  ...
  status[1] = pthread_create(&thread_id[1], NULL, do_sum2, (void *)&a);
  status[2] = pthread_create(&thread_id[2], NULL, do_sum2, (void *)&a);
